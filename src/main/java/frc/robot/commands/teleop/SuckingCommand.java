...
public class SuckingCommand extends Command {
    ...
    public SuckingCommand(SuckingSubsystem suckingSubsystem,Supplier<Boolean> moveUp, Supplier<Boolean> moveDown, Supplier<Boolean> sucking) {
        this.moveUp = moveUp;
