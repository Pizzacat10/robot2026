...
import frc.robot.models.PIDContainer;
import frc.robot.models.bools.StickyBoolean;
...
public class HeadingController {
    ...
    public double update(Rotation2d currentHeading) {
        return clamp(m_pidController.calculate(currentHeading.getDegrees()), -SwerveConstants.maxAngularVelocity, SwerveConstants.maxAngularVelocity);
    }
    ...
    public void smartChangePIDController(ChassisSpeeds robotRelativeVelocity) {
        ...
        } else if (velocity > SwerveConstants.maxSpeed * 0.3) {
            // stabalize
